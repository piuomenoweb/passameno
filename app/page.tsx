  ...
  return (
    <>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="ambient-blob bg-blue-300 w-96 h-96 top-0 left-0 -translate-x-1/2 -translate-y-1/2"></div>
        <div className="ambient-blob bg-purple-200 w-[500px] h-[500px] bottom-0 right-0 translate-x-1/3 translate-y-1/3"></div>
        <div className="ambient-blob bg-pink-100 w-80 h-80 top-1/3 right-1/4 opacity-40"></div>
      </div>
      ...
      <nav className="fixed top-0 left-0 w-full z-50 glass-panel border-b-0 h-16 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-bold text-lg tracking-tight text-slate-900">Contacts App</h1>
          </div>
        </div>
      </nav>
        ...
        <div className="w-full max-w-3xl flex flex-col items-center text-center gap-6 mb-12">
          ...
          <div className="w-full relative group">
            ...
            <input
              ...
              className="glass-input w-full h-16 pl-14 pr-6 rounded-full text-lg placeholder:text-slate-400 focus:ring-4 focus:ring-primary/20 focus:border-primary/50 transition-all shadow-sm group-hover:shadow-md outline-none"
            />
            <div className="absolute inset-y-0 right-3 flex items-center">
              <button className="w-10 h-10 rounded-full bg-white/50 flex items-center justify-center text-slate-500 hover:text-primary hover:bg-white transition-colors">
