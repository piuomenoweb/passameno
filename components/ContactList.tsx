  ...
  if (contacts.length === 0) {
    return (
      <div className="glass-card rounded-2xl p-12 text-center">
        <span className="material-symbols-outlined text-6xl text-slate-300 dark:text-slate-600 mb-4">contacts</span>
        <p className="text-slate-500 dark:text-slate-400 text-lg font-medium">Nessun contatto trovato</p>
        <p className="text-slate-400 dark:text-slate-500 text-sm mt-2">Prova a modificare i filtri di ricerca</p>
      </div>
    )
  }
